...
class CustomCredentials implements CustomTransactionSender {
  ...
  Future<String> sendTransaction(Transaction transaction) async {
    print(transaction.value!.getInWei.toRadixString(16));
  ...
  Uint8List signPersonalMessageToUint8List(Uint8List payload, {int? chainId}) {
    // TODO: implement signPersonalMessageToUint8List
    throw UnimplementedError();
  }
  ...
  @override
  Uint8List signToUint8List(Uint8List payload,
      {int? chainId, bool isEIP1559 = false}) {
    // TODO: implement signToUint8List
    throw UnimplementedError();
  }
}
